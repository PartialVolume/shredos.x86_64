...
#### ../board/shredos/populate_efi_partition.sh
populate_efi_partition.sh is a bash script that copies the ShredOS files
(similar ones as `make_img_file.sh`) to the UEFI partition of the ISO image.
